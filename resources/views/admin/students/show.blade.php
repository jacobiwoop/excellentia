...
@section('content')
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-5">
            ...
            <a href="{{ route('admin.students.index') }}" class="btn btn-light border">
                    ...
                    <div class="p-4 p-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <p class="mb-0 fs-5">
                                        <i class="fas fa-map me-2 text-secondary"></i>
                                    ...
                                    <table class="table grade-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $grade->devoir ?? '-' }}</td>
                                                <td>{{ $grade->composition ?? '-' }}</td>
                                                <td>{{ $grade->moy_interro ? number_format($grade->moy_interro, 2) : '-' }}</td>
                                                <td>{{ $grade->moy_continue ? number_format($grade->moy_continue, 2) : '-' }}</td>
