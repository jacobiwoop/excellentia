        ...
        <div class="col-md-8 col-lg-6">
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                <div class="card-header bg-white border-bottom-0 py-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <h2 class="h5 mb-0 fw-semibold text-gray-800">
                            <i class="fas fa-tag me-2" style="color: #f08b04"></i>Ajouter une promotion
                        </h2>
                        <a href="{{ route('admingen.promotions.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                ...
                <div class="card-body px-4 py-4">
                    <form action="{{ route('admingen.promotions.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end gap-3 pt-3">
                            ...
                            <a href="{{ route('admingen.promotions.index') }}" class="btn btn-light px-4 py-2 rounded-2 fw-medium">
                                Annuler
                            </a>
                        </div>
                    </form>
