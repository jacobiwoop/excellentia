    ...
    <div class="container-fluid py-4">
        ...
        <div class="card mb-4">
            <div class="card-header bg-white d-flex flex-column flex-md-row justify-content-between align-items-center">
                ...
                <a href="{{ route('admingen.attendance.create') }}"
                    class="btn btn-success shadow-sm rounded-pill d-flex align-items-center">
                    <i class="fas fa-plus me-2"></i> Nouvelle présence
                </a>
            </div>
        </div>
                            ...
                            @foreach($filieres as $filiere)
                                <tr>
                                    ...
                                    <td data-label="Détails">
                                        <button
                                            class="btn btn-sm bg-dark text-white rounded-pill px-3 shadow-sm d-flex align-items-center"
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header  text-white">
                    ...
                    <button type="button"
                        ...
                        data-bs-dismiss="modal" aria-label="Fermer" style="width: 32px; height: 32px;">
