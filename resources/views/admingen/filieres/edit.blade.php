            ...
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                <div class="card-header bg-white border-bottom-0 py-4">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admingen.filieres.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                ...
                <div class="card-body px-4 py-4">
                    <form action="{{ route('admingen.filieres.update', $filiere) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-end gap-3 pt-3">
                            ...
                            <a href="{{ route('admingen.filieres.index') }}" class="btn btn-light px-4 py-2 rounded-2 fw-medium">
                                Annuler
                            </a>
                        </div>
                    </form>
