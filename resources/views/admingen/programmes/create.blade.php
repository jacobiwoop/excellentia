        ...
        <div class="col-md-8 col-lg-6">
            <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                <div class="card-header bg-white border-bottom-0 py-4 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admingen.programmes.index') }}" class="btn btn-sm btn-outline-secondary rounded-pill px-3">
                        <i class="fas fa-arrow-left me-1"></i> Retour
                    </a>
                </div>

                <div class="card-body px-4 py-4">
                    <form method="POST" action="{{ route('admingen.programmes.store') }}">
                        @csrf
