...
@section('content')
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-5">
            ...
            <a href="{{ route('superadmin.students.index') }}" class="btn btn-light border">
...
<form action="{{ route('superadmin.students.updateStatut', $student->id) }}" method="POST" class="d-flex flex-wrap gap-2">
        @csrf
        @method('PUT')
