...
<div class="container mt-4">
    <h2>Configurer les frais (Super Admin)</h2>
    <form action="{{ route('superadmin.fees.store') }}" method="POST">
        @csrf
        ...
        <a href="{{ route('superadmin.fees.index') }}" class="btn btn-secondary">Annuler</a>
    </form>
</div>
@endsection