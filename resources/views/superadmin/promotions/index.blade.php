...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('superadmin.promotions.create') }}" class="btn btn-primary shadow-sm">
                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="pe-4 py-3 text-end">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('superadmin.promotions.edit', $promotion->id) }}" 
                                       class="btn btn-sm btn-outline-primary rounded-pill px-3"
                                       data-bs-toggle="tooltip" title="Modifier">
                                        <i class="fas fa-edit text-secondary"></i>
                                    </a>
                                    
                                    <form action="{{ route('superadmin.promotions.destroy', $promotion->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-5">
                                ...
                                <a href="{{ route('superadmin.promotions.create') }}" class="btn btn-primary mt-3">
