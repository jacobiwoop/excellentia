...
<div class="container-fluid px-3 py-4">
    ...
    <div class="row mb-4">
        <div class="col-12 d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            ...
            <a href="{{ route('superadmin.formateurs.create') }}" class="btn btn-primary btn-sm rounded-pill hover-scale">
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-2 align-middle text-end">
                                <div class="d-flex justify-content-end gap-1">
                                    <a href="{{ route('superadmin.formateurs.edit', $formateur->id) }}"
                                       class="btn btn-sm btn-outline-warning rounded-pill hover-scale px-2"
                                       data-bs-toggle="tooltip" title="Modifier">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    
                                    <form action="{{ route('superadmin.formateurs.destroy', $formateur->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
