...
<div class="container py-5">
    <h2>Créer un nouvel Admin Général</h2>
    ...
    <form action="{{ route('superadmin.admin_gen.store') }}" method="POST">
        @csrf
        ...
        <button type="submit" class="btn btn-primary">Créer l'Admin Général</button>
    </form>
</div>
@endsection
<script>
