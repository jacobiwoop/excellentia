        ...
        <div class="col-md-10 col-lg-8">
            <div class="card border-0 shadow-lg">
                <div class="card-header text-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('superadmin.programmes.index') }}" class="btn btn-sm btn-light">
                        <i class="fas fa-arrow-left mr-1"></i> Retour
                    </a>
                </div>

                <div class="card-body p-4">
                    <form method="POST" action="{{ route('superadmin.programmes.update', $programme->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <a href="{{ route('superadmin.programmes.index') }}" class="btn btn-secondary px-4">Annuler</a>
                        </div>
                    </form>
                </div>
            </div>
