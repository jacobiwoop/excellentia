    ...
    <div class="container-fluid px-0 px-md-3">
        <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
            <div class="card-header text-white py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('superadmin.programmes.create') }}" class="btn btn-light btn-sm rounded-pill px-3">
                            ...
                            @forelse($programmes as $programme)
                                <tr>
                                    ...
                                    <td class="py-3 px-3 align-middle text-center">
                                        <a href="{{ route('superadmin.programmes.edit', $programme->id) }}"
                                            class="btn btn-outline-warning btn-sm mx-1" title="Modifier">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('superadmin.programmes.destroy', $programme->id) }}"
