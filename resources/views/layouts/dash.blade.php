    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <!-- Admins -->
          <li class="menu-item">
            <a href="{{ route('superadmin.admins.index') }}" class="menu-link">
          ...
          <!-- Promotions -->
          <li class="menu-item">
            <a href="{{ route('superadmin.promotions.index') }}" class="menu-link">
          ...
          <!-- Filières -->
          <li class="menu-item">
            <a href="{{ route('superadmin.filieres.index') }}" class="menu-link">
          ...
          <!-- Assignations -->
          <li class="menu-item">
            <a href="{{ route('superadmin.assignations.index') }}" class="menu-link">
          ...
          <!-- Matières -->
          <li class="menu-item">
            <a href="{{ route('superadmin.subjects.index') }}" class="menu-link">
          ...
          <!-- Formateurs -->
          <li class="menu-item">
            <a href="{{ route('superadmin.formateurs.index') }}" class="menu-link">
          ...
          <!-- Programmes -->
          <li class="menu-item">
            <a href="{{ route('superadmin.programmes.index') }}" class="menu-link">
          ...
          <!-- Présence -->
          <li class="menu-item">
            <a href="{{ route('superadmin.attendance.overview') }}" class="menu-link">
            ...
            <!-- Comptabilité -->
          <li class="menu-item">
            <a href="{{ route('superadmin.student_fees.index') }}" class="menu-link">
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item pe-2">
                <a class="nav-link text-dark fw-bold fs-3" href="{{ route('superadmin.profil.edit') }}" title="Modifier mon profil">
