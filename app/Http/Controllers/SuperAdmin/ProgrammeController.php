...
class ProgrammeController extends Controller
{
  public function index()
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.programmes.index')->with('success', 'Programme enregistré pour les filières sélectionnées !');
    }
    ...
    {
        return view('superadmin.programmes.edit', [
