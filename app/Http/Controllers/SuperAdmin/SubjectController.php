    ...
    public function index()
{
    ...
    public function create()
    {
        ...
        return view('superadmin.subjects.create', compact('filieres'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin.subjects.index')->with('success', 'Matière ajoutée avec succès');
    }
    ...
    public function edit(Subject $subject)
    {
        ...
        return view('superadmin.subjects.edit', compact('subject', 'filieres'));
    }
    ...
    public function update(Request $request, Subject $subject)
    {
        ...
        return redirect()->route('superadmin.subjects.index')->with('success', 'Matière mise à jour');
    }

    public function destroy(Subject $subject)
    {
        $subject->delete();
        return redirect()->route('superadmin.subjects.index')->with('success', 'Matière supprimée');
    }
}
